...
class ShortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create short" do
    assert_difference('Short.count') do
      post shorts_url, params: { short: { name: @short.name, seq: @short.seq, sequenceSequence: @short.sequenceSequence, shotID: @short.shotID } }, as: :json
    end
  ...
  test "should update short" do
    patch short_url(@short), params: { short: { name: @short.name, seq: @short.seq, sequenceSequence: @short.sequenceSequence, shotID: @short.shotID } }, as: :json
    assert_response 200
  end
